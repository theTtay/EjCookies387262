<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cookies.aspx.cs" Inherits="Cookies3874262.Cookies" %>
...
<body>
    <form id="form1" runat="server">
        <asp:Label ID="Label1" runat="server" BorderColor="Black" Text="Enter Product"></asp:Label>
        <p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:TextBox ID="txtDescription" runat="server" ClientIDMode="Predictable" Height="81px" Width="141px"></asp:TextBox>
        </p>
